      ...
      >
        {slides.map((slide) => (
          <SwiperSlide key={slide.id}>
            <div className={`bg-gradient-to-br ${slide.gradient} py-16 lg:py-24`}>
              <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                  {/* Content */}
                  <div className="text-center lg:text-left order-2 lg:order-1">
                    <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-cherry/10 text-cherry mb-6">
                      {slide.icon}
                    </div>
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                      <Link 
                        ...
                        className="btn-capsule text-lg px-8 py-3 inline-flex items-center justify-center gap-2"
                      >
                      ...
                      <Link 
                        ...
                        className="btn-ghost-capsule text-lg px-8 py-3 inline-flex items-center justify-center"
                      >
                  ...
                  <div className="order-1 lg:order-2">
                    <div className="relative">
                      ...
                      <img
                        src={slide.image}
                        alt={slide.title}
                        className="relative rounded-3xl shadow-2xl w-full h-[300px] md:h-[400px] object-cover"
                      />
                      {/* Floating elements */}
